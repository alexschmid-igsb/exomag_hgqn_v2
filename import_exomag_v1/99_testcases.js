    ...
    */
    ...
    // PROCESS OLD CASES
    {
        ...
        for(const oldCase of oldCases) {
            ...
            if(Object.keys(oldCase).length > max) {
                max = Object.keys(oldCase).length
                pos = i
            }
        ...
        */
        ...
        let filter = [
            ...
            // 'Homozygote; Homozygote; Compound Heterozygote; Compound Heterozygote; Heterozygote; Heterozygote; Heterozygote',
            // 'Heterozygote; Heterozygote; Heterozygote; Heterozygote; Heterozygote; Heterozygote; Hemizygote; Compound Heterozygote; Compound Heterozygote; Compound Heterozygote; Hemizygote',
            // 'Compound Heterozygote; Compound Heterozygote',
            // 'comp het/comp het',
            // 'comp het',
            // 'homozygous/comp het/comp het/comp het/heterozygous',
            // 'comp het/heterzygous/hemizygous/hemizygous/hemizygous',
            // 'heterozygous/heterozygous/comp het/comp het/comp het/comp het/hemizygous/hemizygous/hemizygous/hemizygous/hemizygous/hemizygous',
            // 'compound heterozygote/compound heterozygote',
            // 'comp het/comp het/comp het',
            // 'heterozygous/ comp het/heterozygous',
            // 'Compound het',
            // 'compond het',
            // 'compound heterozygous',
            // 'compound het',
            // 'heterozygous/ comp het',
            // 'Compound_Heterozygote/Compound_Heterozygote',
            // 'Heterozygote/Compound_Heterozygote/Compound_Heterozygote',
            // 'Compound_Heterozygote/Compound_Heterozygote/Compound_Heterozygote',
            // 'Compound_Heterozygote/Compound_Heterozygote/Heterozygote',
            // 'Compound_Heterozygote/Compound_Heterozygote/Hemizygote/Heterozygote',
        ...
        for(const oldCase of oldCases) {
            ...
            let value = oldCase['zygosity']


            /*
            if(true || filter.includes(value)) {
                console.log()
                for(let key of fields) {
                    console.log(key + ': ' + oldCase[key])
                }
            }
            */
            ...
            if(
                oldCase['HGVS_cDNA'] != null &&
                oldCase['HGVS_gDNA'] != null &&
                oldCase['gene'] != null &&
                oldCase['zygosity'] != null &&
                oldCase['mode of inheritance'] != null &&
                oldCase['ACMG class'] != null &&
                oldCase['de novo'] != null
            ) {
                // console.log(oldCase)
                console.log()
                for(let key of fields) {
            ...
            /*
            if(oldCase['internal case ID'] === '131258') {
                // console.log()
                // console.log(oldCase)
                for(let key of fields) {
                    console.log(key + ': ' + oldCase[key])
